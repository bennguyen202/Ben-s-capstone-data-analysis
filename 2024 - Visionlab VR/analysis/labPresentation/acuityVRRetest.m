...
% Extract VR Visual Acuity data for both sessions
% Session 1
right_s1 = data1.VR_acuity_uncorr_R(1:n_participants);
left_s1 = data1.VR_acuity_uncorr_L(1:n_participants);
bino_s1 = data1.VR_acuity_uncorr_B(1:n_participants);

% Session 2
right_s2 = data2.VR_acuity_uncorr_R(1:n_participants);
left_s2 = data2.VR_acuity_uncorr_L(1:n_participants);
bino_s2 = data2.VR_acuity_uncorr_B(1:n_participants);
...
plot([0.3 0.8], [0.3 0.8], 'k--', 'LineWidth', 2);
...
title('Test-Retest Reliability of Visual Acuity Measurements (VR)');
grid on;
