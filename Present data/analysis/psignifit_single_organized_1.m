...
create_threshold_table = false;

% toggles for combined plots
create_combined_psychometric = false; % combined plot for subjects listed below
batch_processing = false; % saves all 3 figures for all participants listed below
create_parameter_distributions = true; % histograms for slope and lapse rates

% for batch processing
subjects = {'002', '007','010', '011','012', '013', '015','016', '017', '018'};
% subjects = {'010', '011', '012'};
sessions = {'01', '02'};
...
if create_parameter_distributions
    plot_parameter_distributions(experiment_type, subjects, sessions, eccentricity);
end
...
function plot_parameter_distributions(experiment_type, subjects, sessions, eccentricity)
