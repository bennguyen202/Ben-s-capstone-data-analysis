...
x = [VRDATA.abraiz_fast_C6.list.TrialNumber]; % extract trial number and logmar score
y = [VRDATA.abraiz_fast_C6.list.LogMAR];

c1 = [VRDATA.abraiz_fast_C6.list.EyeCondition] == "Both_Eyes"; % extract eye condition
c2 = [VRDATA.abraiz_fast_C6.list.EyeCondition] == "Right_Eye";
c3 = [VRDATA.abraiz_fast_C6.list.EyeCondition] == "Left_Eye";
...
real_both = -0.04; % real logmar score
real_right = 0.08;
real_left = 0.02;
...
% % The resolution of the Quest 2 is 20 pixels/degree
% % so, 10 cycles/degree, or log10(30/cycpdeg) logMar
% yline(log10(30/10),'-.g','LineWidth',1) % Quest 2
% yline(log10(30/12.5),'--r','LineWidth',1) % Quest 3
% legend('data','perfect performance', 'quest 2 limit','quest 3 limit','Location', 'northeastoutside')
% 
% 
% figure % scatter real and vr results (uc)
...
% 
% 
% legend('data','perfect performance','least square line','Location', 'northeastoutside')

%% t test
su1_x = [VRDATA.AB_009_C6.list.TrialNumber]; % extract trial number and logmar score for subject 1
su1_y = [VRDATA.AB_009_C6.list.LogMAR];

su1_c1 = [VRDATA.AB_009_C6.list.EyeCondition] == "Both_Eyes"; % extract eye condition
su1_c2 = [VRDATA.AB_009_C6.list.EyeCondition] == "Right_Eye";
su1_c3 = [VRDATA.AB_009_C6.list.EyeCondition] == "Left_Eye";

su1_x1 = su1_x(c1); % match logmar score to condition
su1_b = su1_y(c1);
...
su2_x = [VRDATA.abraiz_fast_C6.list.TrialNumber]; % extract trial number and logmar score for subject 2
su2_y = [VRDATA.abraiz_fast_C6.list.LogMAR];

su2_c1 = [VRDATA.abraiz_fast_C6.list.EyeCondition] == "Both_Eyes"; % extract eye condition
su2_c2 = [VRDATA.abraiz_fast_C6.list.EyeCondition] == "Right_Eye";
su2_c3 = [VRDATA.abraiz_fast_C6.list.EyeCondition] == "Left_Eye";

su2_x1 = su2_x(c1); % match logmar score to condition
su2_b = su2_y(c1);
...
[h,p] = ttest2(su1_b,su2_b) % two sample t test for individual condition